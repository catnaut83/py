...
favorite_fruits = ['manga', 'morango', 'nectarina']

if 'manga' in favorite_fruits:
    print("Você realmente gosta de mangas")
if 'pessego' in favorite_fruits:
    print("Voce realmente gosta de pessegos")
if 'abacaxi' in favorite_fruits:
    print("Voce realmente gosta de abacaxi.")
if 'morango' in favorite_fruits:
    print("Voce realmente gosta de morangos")
