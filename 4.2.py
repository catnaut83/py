...
felinos = ['gato', 'onça', 'leão', 'tigre']

for felino in felinos:
    print("O " + felino.title() + " é uma perfeição da natureza!")

print("Enfim, esses animais são exemplares maravilhosos de felino")
print("Sendo apenas o " + felinos[0].title() + " possível conviver com humanos por serem mais domesticaveis")
